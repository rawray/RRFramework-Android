...
import com.rawray.rrframework.vendor.refreshlayout.RefreshLayout;
...
public abstract class AbsRefreshRecyclerStatusFragment extends AbsRecyclerStatusFragment {
    ...
    protected void initStatusLayout() {
        statusLayoutManager = StatusLayoutManager.newBuilder(getActivity())
                .contentView(R.layout.fragment_absrefreshrecycler)
    ...
    protected void setRefreshing(boolean value) {
        if (value) {
            mRefreshLayout.autoRefresh(); //TODO maybe error
        } else {
